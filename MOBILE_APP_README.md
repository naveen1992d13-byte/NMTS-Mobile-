...
| 4 | `assets/nmts-request-ring.wav` | Request alert sound | Place the chosen ringing sound here (filename must stay `nmts-request-ring.wav`), then add it to the `expo-notifications` plugin `sounds` array in `app.json`. |
